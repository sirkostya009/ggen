...
| `merge_test.go`         | Decode-into-receiver: omitted keys zeroed (every kind, both paths), slice `[:0]` reuse, map `clear()` reuse, carried slice-element allocations reused, `null` → nil, `[]`/`{}` on non-nil vs nil receiver. **Contract pin.**                                                                                                                                                                                                                                                                                                                           |

...
func (recv SQLNullInt32Struct) DecodeFrom(data []byte) (result SQLNullInt32Struct, i int, err error) {
	...
	for {
		...
		case "i32":
			...
			if i < len(data) && data[i] == 'n' {
				if i+4 > len(data) || data[i+1] != 'u' || data[i+2] != 'l' || data[i+3] != 'l' {
					return result, i, ggen.NewParseErr("i32", i, ggen.ErrBadLiteral)
				}
				i += 4
...
func (recv SQLNullInt16Struct) DecodeFrom(data []byte) (result SQLNullInt16Struct, i int, err error) {
	...
	for {
		...
		case "i16":
			...
			if i < len(data) && data[i] == 'n' {
				if i+4 > len(data) || data[i+1] != 'u' || data[i+2] != 'l' || data[i+3] != 'l' {
					return result, i, ggen.NewParseErr("i16", i, ggen.ErrBadLiteral)
				}
				i += 4
	...
	for {
		...
		case "b":
			...
			if i < len(data) && data[i] == 'n' {
				...
				result.B = sql.NullByte{Byte: uint8(n), Valid: true}
			}
		default:
			return result, i, &ggen.UnknownKeyError{Pos: i, Path: []string{key}}
		}
	...
	for {
		...
		case "b":
			...
			if s.Bytes()[s.Pos] == 'n' {
				...
				if nv > math.MaxUint8 {
					return result, ggen.NewParseErr("b", s.Offset(), ggen.ErrNumberOverflow)
				}

				result.B = sql.NullByte{Byte: uint8(nv), Valid: true}
			}
		default:
			ownKey := strings.Clone(key)
			err = s.ConsumeColon()
...
func (recv SQLNullBoolStruct) DecodeFrom(data []byte) (result SQLNullBoolStruct, i int, err error) {
	...
	for {
		...
		case "bl":
			...
			if i < len(data) && data[i] == 'n' {
				if i+4 > len(data) || data[i+1] != 'u' || data[i+2] != 'l' || data[i+3] != 'l' {
					return result, i, ggen.NewParseErr("bl", i, ggen.ErrBadLiteral)
				}
				i += 4
...
func (recv SQLNullTimeStruct) DecodeFrom(data []byte) (result SQLNullTimeStruct, i int, err error) {
	...
	for {
		...
		case "t":
			...
			if i < len(data) && data[i] == 'n' {
				if i+4 > len(data) || data[i+1] != 'u' || data[i+2] != 'l' || data[i+3] != 'l' {
					return result, i, ggen.NewParseErr("t", i, ggen.ErrBadLiteral)
				}
				i += 4
...
func (s SQLNullTimeStruct) AppendJSON(dst []byte) ([]byte, error) {
	...
	if !s.T.Valid {
		...
		dst = append(dst, '"')
		if dst, err = ggen.AppendRFC3339(dst, s.T.Time, time.RFC3339Nano); err != nil {
			return dst, err
		}
		dst = append(dst, '"')
	}
...
func (s SQLNullGenTimeStruct) AppendJSON(dst []byte) ([]byte, error) {
	...
	if !s.T.Valid {
		...
		dst = append(dst, '"')
		if dst, err = ggen.AppendRFC3339(dst, s.T.V, time.RFC3339Nano); err != nil {
			return dst, err
		}
		dst = append(dst, '"')
	}
...
func (recv SQLNullGenLabelStruct) DecodeFrom(data []byte) (result SQLNullGenLabelStruct, i int, err error) {
	...
	for {
		...
		case "l":
			...
			if i < len(data) && data[i] == 'n' {
				if i+4 > len(data) || data[i+1] != 'u' || data[i+2] != 'l' || data[i+3] != 'l' {
					return result, i, ggen.NewParseErr("l", i, ggen.ErrBadLiteral)
				}
				i += 4
...
func (recv SQLNullGenUUIDStruct) DecodeFrom(data []byte) (result SQLNullGenUUIDStruct, i int, err error) {
	...
	for {
		...
		case "id":
			...
			if i < len(data) && data[i] == 'n' {
				if i+4 > len(data) || data[i+1] != 'u' || data[i+2] != 'l' || data[i+3] != 'l' {
					return result, i, ggen.NewParseErr("id", i, ggen.ErrBadLiteral)
				}
				i += 4

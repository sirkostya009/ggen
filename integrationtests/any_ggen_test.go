...
func (recv AnyStruct) DecodeFromStream(s *ggen.Stream) (result AnyStruct, err error) {
	result = recv
	seenBody := false
	seenName := false
	err = s.ObjectOpen()
...
func (recv AnyNumberStruct) DecodeFromStream(s *ggen.Stream) (result AnyNumberStruct, err error) {
	result = recv
	seenBody := false
	seenName := false
	err = s.ObjectOpen()
